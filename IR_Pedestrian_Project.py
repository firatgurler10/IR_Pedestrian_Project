# -*- coding: utf-8 -*-
"""
Created on Thu Jan 25 11:02:22 2024

@author: Fırat
"""
#IR PEDESTRIAN PROJECT WITH CNN
#kütüphaneler
import torch
...
import os
import time
#device configuration(EKSTRA) default CPU but GPU
...
#%%
#read train negative
train_negative_path = r"C:\Users\Fırat\Desktop\YAZILIM\PYTHON İLE MAKİNE ÖĞRENMESİ\PYTHON(DATAI_TEAM)\LSIFIR\LSIFIR\Classification\Train\neg" 
...
#read train positive
train_positive_path = r"C:\Users\Fırat\Desktop\YAZILIM\PYTHON İLE MAKİNE ÖĞRENMESİ\PYTHON(DATAI_TEAM)\LSIFIR\LSIFIR\Classification\Train\pos"
...
test_negative_path = r"C:\Users\Fırat\Desktop\YAZILIM\PYTHON İLE MAKİNE ÖĞRENMESİ\PYTHON(DATAI_TEAM)\LSIFIR\LSIFIR\Classification\Test\pos"
...
test_positive_path = r"C:\Users\Fırat\Desktop\YAZILIM\PYTHON İLE MAKİNE ÖĞRENMESİ\PYTHON(DATAI_TEAM)\LSIFIR\LSIFIR\Classification\Test\pos"
